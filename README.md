...
This is the [Scalingo buildpack](http://doc.scalingo.com/buildpacks/) for apps
that use [Gradle](https://gradle.org/) as their build tool.
...
Specify an OpenJDK version by creating a `system.properties` file in the root of your project directory and setting the `java.runtime.version` property. See the [Java Support article](https://doc.scalingo.com/languages/java/start#availability) for available versions and configuration instructions.
